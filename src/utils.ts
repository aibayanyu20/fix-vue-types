...
export function isJS(...langs: (string | null | undefined)[]): boolean {
  return langs.some(lang => lang === 'js' || lang === 'jsx')
}
export function isTS(...langs: (string | null | undefined)[]): boolean {
